...
//Same as the other two menus but the title is YOU WON!
public class WinState implements State{
	...
	public void render(Graphics2D g) {
		...
		Fonts.drawString(g, new Font("Arial", Font.BOLD, 72), Color.ORANGE, "YOU WIN!", 80);
